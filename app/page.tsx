          ...
          {twitch.user && (
            <div className="mt-4">
              ...
              <p className="text-sm text-[var(--text-secondary)] mt-2">
                OBS Browser Source URL: <code className="bg-[var(--bg-tertiary)] px-2 py-1 rounded text-xs">https://anarchy-wheel-rc6rgsisj-anarchyy63s-projects.vercel.app</code> (add <code className="bg-[var(--bg-tertiary)] px-2 py-1 rounded text-xs">/transparent</code> for transparent mode)
              </p>
            </div>
          )}
        </div>
